...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Enter new name";
			// 
			// textBox1
			// 
			...
			this->SaveBut->Click += gcnew System::EventHandler(this, &EditName::SaveBut_Click);
			// 
			// CancelBut
			// 
			...
			this->CancelBut->Click += gcnew System::EventHandler(this, &EditName::CancelBut_Click);
			// 
			// EditName
			// 
...
#pragma endregion
	...
	private: System::Void SaveBut_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (name->Length == 0 ) {
			MessageBox::Show("Please enter an updated name",
		...
		try {
			...
			String^ updateQuery = "UPDATE MyTable SET Name = @Name";
