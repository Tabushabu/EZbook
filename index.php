    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">EZBook Hotel Management System| <a href="https://github.com/Tabushabu/EZbook" target="_blank">Our Github</a></div></div>
        </footer>
